 ...
 * @author vjthe
 */
public class User_Tutor extends User{
    ...
    public void User_Tutor_Register(String Utente[]){
        ...
        try{
            ...
            query_AddPnS = "INSERT INTO tutor (IDpns, qualifica, data_inizio) VALUES('"+IDutente+"', '"+Utente[9]+"', '"+Utente[10]+"')";
            stm.executeUpdate(query_AddPnS);
